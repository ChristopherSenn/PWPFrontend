...
export const getDeviceDetails = async (deviceId) => {
    try{
        ...
        return await axios.get('http://pwp21.medien.ifi.lmu.de:54500/devices/getDeviceDetails?deviceId=' + deviceId,
        requestHeader
        )
    }catch(error){
...
export const deleteDevice = async (deviceId) => {
    try{
        ...
        return await axios.delete('http://pwp21.medien.ifi.lmu.de:54500/devices/deleteDevice?deviceId=' + deviceId,
        requestHeader
        )
    }catch(error){
        console.log(error.message)
...
export const getHubPassword = async (hubId) => {
    try{
        ...
        return await axios.get('http://pwp21.medien.ifi.lmu.de:54500/hubs/password?hubId=' + hubId,
        requestHeader
        )
    }catch(error){
        console.log(error.message)
